...
ALTER TABLE "civilio"."choices" ADD COLUMN "description" text;--> statement-breakpoint
ALTER TABLE "civilio"."form_fields" DROP CONSTRAINT "form_fields_section_key_form_name_form_sections_key_form_fkey", ADD CONSTRAINT "form_fields_section_key_form_name_form_sections_key_form_fkey" FOREIGN KEY ("section_key","form_name") REFERENCES "civilio"."form_sections"("key","form") ON DELETE CASCADE ON UPDATE CASCADE;--> statement-breakpoint
