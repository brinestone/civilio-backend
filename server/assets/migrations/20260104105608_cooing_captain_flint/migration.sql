create function revisions.func_log_submission_state(p_index integer, p_form TEXT) returns text
    language plpgsql
as
$$
DECLARE
...
create procedure revisions.revert_submission(IN p_form TEXT, IN p_index integer, IN p_version text,
                                             IN p_change_notes text, IN p_actor text,
                                             IN p_new_version text DEFAULT NULL::text)
    language plpgsql
as
$$
DECLARE
...
create procedure revisions.sync_version(IN p_form TEXT, IN p_index integer, IN p_version text DEFAULT NULL::text)
    language plpgsql
as
$$
DECLARE
...
create function revisions.func_update_ledger() returns trigger
    language plpgsql
as
$$
BEGIN
