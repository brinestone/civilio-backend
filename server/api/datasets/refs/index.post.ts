			...
			content: {
				'application/json': {
					schema: {
						...
						required: ['dataset', 'followDatasetUpdates'],
						properties: {
							dataset: {
							...
							selectAll: {
								description: 'Whether all items in the dataset should be used',
								type: 'boolean',
								default: false
							},
							followDatasetUpdates: {
								description: 'Whether to update this reference if the dataset items updates. This is only relevant if the selectAll option is enabled',
								type: 'boolean'
							}
						}
					}
